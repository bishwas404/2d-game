...
export class StandingLeft extends State{
  ...
  enter(){
    ...
    this.player.speed = -this.gameSpeed*1.2;
...
export class SittingLeft extends State{
  ...
  handleInput(input){
    ...
    else if(input === 'RELEASED down') this.player.setState(states.STANDING_LEFT);
  }
}
export class SittingRight extends State{
  ...
  handleInput(input){
    ...
    else if(input === 'RELEASED down') this.player.setState(states.STANDING_RIGHT);
  }
}
export class RunningLeft extends State{
  ...
  handleInput(input){
    if(input === 'PRESS right') this.player.setState(states.RUNNING_RIGHT);
    else if(input === 'RELEASED left') this.player.setState(states.STANDING_LEFT);
    else if(input === 'PRESS down') this.player.setState(states.SITTING_LEFT);
  }
}
export class RunningRight extends State{
  ...
  handleInput(input){
    if(input === 'PRESS left') this.player.setState(states.RUNNING_LEFT);
    else if(input === 'RELEASED right') this.player.setState(states.STANDING_RIGHT);
    else if(input === 'PRESS down') this.player.setState(states.SITTING_RIGHT);
  }
}
